...
## ⚠️ Отказ от ответственности и предупреждение о блокировках

> [!WARNING]
> **Уведомление об использовании неофициальных протоколов WhatsApp и сторонних сервисов:**
> - **Apogee** является независимым программным проектом и **не связан**, не одобрен и не аффилирован с **Meta Platforms, Inc.**, **WhatsApp**, **Telegram FZ-LLC**, **Discord Inc.** или **Google LLC**.
> - Модуль WhatsApp использует неофициальные механизмы автоматизации WhatsApp Web. Использование ботов или скриптов автоматизации может нарушать Пользовательское соглашение (Terms of Service) WhatsApp и потенциально привести к временному ограничению или **перманентной блокировке телефонного номера (Account Ban)** со стороны Meta.
> - **Полная ответственность пользователя:** Автор (**ByKpubaq | Adil**) и контрибьюторы **не несут никакой ответственности** за блокировки аккаунтов, утерю сообщений, ограничение доступа к сервисам или любые иные последствия. Вся ответственность за использование программы и связанные риски лежит исключительно на конечном пользователе.
